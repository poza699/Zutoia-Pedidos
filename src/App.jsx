...
const NAME_EMOJI_RULES = [
  ...
  [/cigarro|tabaco/, "🚬"],
  [/paquete|caja/, "📦"],
  [/\bcomida\b|alimentaci[oó]n|alimentos?\b|gourmet/, "🍽️"],
...
const DEFAULT_SUPPLIERS = [
  ...
  },
  {
    ...
    greeting: "",
    categories: [
      { id: "cat-makro-bebidas", name: "Bebidas", products: [] },
      { id: "cat-makro-comida", name: "Comida", products: [] },
      { id: "cat-makro-limpieza", name: "Limpieza", products: [] },
      { id: "cat-makro-otros", name: "Otros", products: [] },
    ],
  },
];
...
export default function App() {
  ...
  function restoreFactoryDefaults() {
    const ok = window.confirm(
      "¿Restaurar el catálogo de fábrica? Se perderá cualquier proveedor, familia o producto que hayas añadido o cambiado tú mismo en la app."
    );
    if (!ok) return;
    setSuppliers(DEFAULT_SUPPLIERS);
    setCarts({});
    showToast("Catálogo restaurado a los valores de fábrica", "success");
  }
      ...
      <div className="relative min-h-screen overflow-x-hidden" style={{ color: C.textPrimary }}>
        ...
        <div className="px-4 pt-5 pb-16">
          ...
          <button
            ...
            className="w-full mb-5 py-2.5 rounded-2xl text-xs font-bold flex items-center justify-center gap-2 active:scale-95 transition-transform duration-150"
            style={{ backgroundColor: "transparent", color: C.danger, border: `1px dashed ${hexToRgba(C.danger, 0.4)}` }}
          >
            <RotateCcw size={13} />
